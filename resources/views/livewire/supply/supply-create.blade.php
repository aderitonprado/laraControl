        ...
        <div class="container">
            <form name="createSupply" wire:submit.prevent="createSupply">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <select name="warehouse" class="form-control @error('supply.warehouse') border border-danger @enderror" aria-label="warehouse" aria-describedby="warehouse" wire:model="supply.warehouse">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="hour_meter" class="form-control @error('supply.hour_meter') border border-danger @enderror" placeholder="Horimetro" aria-label="hour_meter" aria-describedby="hour_meter" wire:model="supply.hour_meter">
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="text" name="pump_price" class="form-control @error('supply.pump_price') border border-danger @enderror" placeholder="R$ 0,00" aria-label="pump_price" aria-describedby="pump_price" wire:model="supply.pump_price">
                        </div>
