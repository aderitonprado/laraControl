        ...
        <div class="container">
            <form name="showThirdParty">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="text" name="third_party_code" disabled
                                class="form-control"
                                placeholder="Codigo do terceiro" aria-label="third_party_code" aria-describedby="third_party_code"
                    ...
                    <div class="col-sm-12">
                        <div class="input-group">
                            <textarea name="obs" class="form-control" placeholder="Digite sua observação"
                                aria-label="obs" aria-describedby="obs" wire:model="thirdparties.obs" rows="3" disabled>
                            </textarea>
                        </div>
                    </div>
